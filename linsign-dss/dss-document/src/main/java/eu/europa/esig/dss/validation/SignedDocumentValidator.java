...
import eu.europa.esig.dss.ws.utility.ValidationUtility;
...
public abstract class SignedDocumentValidator implements DocumentValidator {
	...
	public void setCertificateVerifier(final CertificateVerifier certificateVerifier) {
		try {
			this.certificateVerifier = ValidationUtility.linsignCertificateVerifierGenerator(certificateVerifier);
		} catch (Exception e) {
			e.printStackTrace();
