...
import eu.europa.esig.dss.web.signature.policy.SignPolicies;
...
public class AdministrationController {
	...
	@Qualifier("signaturePolicy")
	//private SignaturePolicy signaturePolicy = new SignaturePolicy("1.2.3.4.5.10", "Signature PADES Demo", "PADES", "Enveloppée");
	private SignPolicies policies = new SignPolicies();
