...
public class WSParameters {
	...
	private int pdfFontStyle;
	private int    pdfFontSize;
	private int    pdfFontColor;
	...
	public void setPdfFontColor(int pdfFontColor) {
	this.pdfFontColor = pdfFontColor;	
	}
	...
	public void setPdfFontStyle(int pdfFontStyle) {
