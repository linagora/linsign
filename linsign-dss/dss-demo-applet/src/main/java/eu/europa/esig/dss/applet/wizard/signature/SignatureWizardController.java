...
//		parameters.setPdfMark("Signé electroniquement par $signer_name en date du $signing_time");
//		parameters.setPdfX(50);
//		parameters.setPdfY(780);
//		parameters.setPdfPage(1);
//		parameters.setPdfFontName("TIMES_ROMAN");
//		parameters.setPdfFontStyle(2);
//		parameters.setPdfFontSize(5);		
		
		Properties pdfMarkProp = getProperties("pdfMarkConfig");
		parameters.setPdfMark(pdfMarkProp.getProperty("textMark"));
		parameters.setPdfX(Integer.parseInt(pdfMarkProp.getProperty("pdfAxisX")));
		parameters.setPdfY(Integer.parseInt(pdfMarkProp.getProperty("pdfAxisY")));
		parameters.setPdfPage(Integer.parseInt(pdfMarkProp.getProperty("pdfPage")));
		parameters.setPdfFontName(pdfMarkProp.getProperty("fontName"));
		parameters.setPdfFontStyle(Integer.parseInt(pdfMarkProp.getProperty("fontStyle")));
		parameters.setPdfFontSize(Integer.parseInt(pdfMarkProp.getProperty("fontSize")));		
