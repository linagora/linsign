...
public class MyJPanelBackground extends JPanel {
	 ...
	 * Set image as the background with the SCALED style
	 */
	public MyJPanelBackground(Image image) {
		this(image, SCALED);
	}
	 ...
	 */
	public MyJPanelBackground(Image image, int style) {
		setImage(image);
		setStyle(style);
	 ...
	 */
	public MyJPanelBackground(Image image, int style, float alignmentX, float alignmentY) {
		setImage(image);
		setStyle(style);
	 ...
	 */
	public MyJPanelBackground(Paint painter) {
		setPaint(painter);
		setLayout(new BorderLayout());
	}
