...
public final class SigningUtils {
	 ...
	 * @throws DSSException
	 */
	public static DSSDocument signDocument(final File file, 
			final WsParameters wsParameters, DSSPrivateKeyEntry privateKey, SignatureTokenConnection tokenConnection) throws DSSException {
