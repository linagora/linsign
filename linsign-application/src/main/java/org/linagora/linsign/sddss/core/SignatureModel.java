 ...
 */
package org.linagora.linsign.sddss.core;
...
import org.linagora.linsign.application.exception.LinSignException;
import org.linagora.linsign.application.exception.LinSignExceptionKind;
import org.linagora.linsign.application.model.dao.MySignaturePolicy;
import org.linagora.linsign.sddss.dao.FileType;
import org.linagora.linsign.sddss.dao.PDFVisibleProperties;
import org.linagora.linsign.sddss.dao.SignatureTokenType;
...
public class SignatureModel extends Model {
	...
	private PDFVisibleProperties pdfMark;

	public void setPdfMarkProperties(PDFVisibleProperties pdfMark) {
		this.pdfMark = pdfMark;
	}

	public PDFVisibleProperties getPdfMarkProperties() {
		return pdfMark;
	}
	...
	/**
	 *
	 * @param tslSignatureCheck
	 *            the tslSignatureCheck to set
	 */
	...
	/**
	 *
	 * @param pkcs11Password
	 *            the pkcs11password to set
	 */
	...
	/**
	 * @param selectedPrivateKey
	 *            the selectedPrivateKey to set
	 */
	 ...
	 *            the signaturePolicyAlgo to set
	 */
	...
	/**
	 * @param signaturePolicyCheck
	 *            the signaturePolicyCheck to set
	 */
	 ...
	 *            the signaturePolicyValue to set
	 */
	...
	public void setMySignaturePolicy(MySignaturePolicy signaturePolicy) throws LinSignException {
		if (signaturePolicy == null)
			throw new LinSignException(LinSignExceptionKind.GENERATE_POLICY_ERROR);

		if (signaturePolicy.getSignatureFormString() != null)
			this.setFormat(signaturePolicy.getSignatureFormString());
		if (signaturePolicy.getSignaturePackaging() != null)
			this.setPackaging(signaturePolicy.getSignaturePackaging());
		if (signaturePolicy.getSignatureLevelString() != null)
			this.setLevel(signaturePolicy.getSignatureLevelString());
		if (signaturePolicy.getSignatureAlgo() != null)
			this.setSignatureDigestAlgorithm(signaturePolicy.getSignatureAlgo());
	}
