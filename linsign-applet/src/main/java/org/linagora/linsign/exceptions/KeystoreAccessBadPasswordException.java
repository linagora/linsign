...
public class KeystoreAccessBadPasswordException extends KeystoreAccessException {
	...
	public KeystoreAccessBadPasswordException(Throwable cause, String keystoreInfo) {
		super(cause,keystoreInfo);
	}
	public KeystoreAccessBadPasswordException (String keystoreInfo) {
		super(keystoreInfo);
	}
	public KeystoreAccessBadPasswordException (Throwable cause) {
		super(cause);
	}
}
