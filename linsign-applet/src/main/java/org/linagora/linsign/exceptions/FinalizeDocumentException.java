...
public class FinalizeDocumentException extends BusinessException {

	private static final long serialVersionUID = 7999378360766574362L;
	
	//main Exception id
	private static final String EXCEPT_ID = "error.linsign.FinalizeDocumentException";
	
	public FinalizeDocumentException(Throwable cause) {
