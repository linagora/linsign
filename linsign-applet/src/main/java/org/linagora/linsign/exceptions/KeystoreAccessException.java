...
public class KeystoreAccessException extends BusinessException {
	...
	public KeystoreAccessException(Throwable cause, String keystoreInfo) {
		super(cause, EXCEPT_ID, new String[] {keystoreInfo});
	}
	public KeystoreAccessException (String keystoreInfo) {
		super(null, EXCEPT_ID, new String[] {keystoreInfo});
	}
