...
public class BadKeyTypeException extends BusinessException {

	private static final long serialVersionUID = 7999378360766574362L;
	
	//main Exception id
	private static final String EXCEPT_ID = "error.linsign.BadKeyTypeException";
	
	
	public BadKeyTypeException(String moreinfolabel) {
		super(null, EXCEPT_ID, new String[] {moreinfolabel});
	}
