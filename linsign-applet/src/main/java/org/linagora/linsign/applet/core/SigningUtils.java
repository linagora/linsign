 ...
 */
package org.linagora.linsign.applet.core;
...
public final class SigningUtils {
	 ...
	 * @throws DSSException
	 */
	public static DSSDocument signDocument(final File file, final WsParameters wsParameters, DSSPrivateKeyEntry privateKey, SignatureTokenConnection tokenConnection) throws DSSException {
	...
	public static String checkCertificate(final WsChainCertificate wsCert) throws DSSException {
		try {
			SignatureService_Service signatureService_service = new SignatureService_Service();
			
			final SignatureService signatureServiceImplPort = signatureService_service.getSignatureServiceImplPort();
			String checkCert = signatureServiceImplPort.checkCertificate(wsCert);
			return checkCert;
		} catch (Exception e) {
			throw new DSSException(e);
		}
	...
	public static WsSignaturePolicy getSignaturePolicy(final String policyRef) throws DSSException {
		try {
			SignatureService_Service signatureService_service = new SignatureService_Service();
			
			final SignatureService signatureServiceImplPort = signatureService_service.getSignatureServiceImplPort();
			WsSignaturePolicy policy = signatureServiceImplPort.getSignaturePolicy(policyRef);
			return policy;
		} catch (Exception e) {
			throw new DSSException(e);
		}
