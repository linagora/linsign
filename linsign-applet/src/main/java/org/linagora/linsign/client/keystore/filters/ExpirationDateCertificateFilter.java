...
/**
 * accept certificates with notbefore<current date<notafter 
 */
public class ExpirationDateCertificateFilter extends KeystoreEntryFilter {


	public ExpirationDateCertificateFilter() {
	}
	...
	public boolean accept(KeyStoreEntry cert) {
		...
		if(currentDate.after(cert.getNotBefore()) && currentDate.before(cert.getNotAfter())) return true;
		else return false;
	}
}
